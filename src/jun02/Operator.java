...
//연산자
/*
 * 모든 프로그램에서는 데이터의 계산을 위해서 연산자를 사용한다.
 * 지금 배울 연산자는 다른 프로그래밍에서도 비슷하게 쓴다.
 * 
 * 주의해서 볼 것은 연산자의 연산 순서이다.
 * 1. 최우선 연산자
...
public class Operator {
	public static void main(String[] args) {
		...
		sh = -1;
		System.out.println(Integer.toBinaryString(sh));
		System.out.println(Integer.toBinaryString(sh >> 2));// 음수니까 앞에 1로 채움
		System.out.println(Integer.toBinaryString(sh << 2));
		System.out.println(Integer.toBinaryString(sh >>> 31));// 앞에 0으로 채움

		sh = -5000;
		// 11111111111111111110110001111000
		// 11111111111111111111101100011110
		// 00111111111111111111101100011110
